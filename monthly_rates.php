    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <h3 style="text-align:center">Monthly Accident rates In Bangladesh</h3>
                <table border="1" width="100%">
                      ...
                      <?php 
                        ...
                        if(isset($_GET['id']))
                           ...
                           $id = $_GET['id'];
                             ...
                             $sql = "SELECT * FROM monthly_analysis LIMIT $start, $limit";
                  ...
                  for($ij=1;$ij<=$page;$ij++)
                    ...
                    echo "<a href=monthly_rates.php?id ".$ij.">".$ij."</a>";
