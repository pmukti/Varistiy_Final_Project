        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <!-- Content Column -->
                 <div class="col-md-6">
                 <?php 
                 $sql = "SELECT * FROM yearly_analysis";
            
                 $res = mysql_query($sql) or die(mysql_error());


                ?>
                <h3 style="text-align:center">Yearly Accident Rates In bangladesh</h3>
                    ...
                    <tbody>
                        <?php while ($data = mysql_fetch_assoc($res)) { ?>
                            <tr>
                                ...
                                <th><?php echo $data['number_of_death'] ?></th>
                                <th><?php echo $data['number_of_injured'] ?></th>
